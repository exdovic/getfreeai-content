...
keywords:
  ...
  - 免费AI API
  - Gemini 2.5 Flash
image: /images/providers/google-ai-studio-og.png
type: docs
weight: 1
comments: true
prev: /providers
...
| 模型系列 | 免费层级 | 每日请求数 | 每日 Tokens |
|---------|---------|----------|-----------|
| Gemini 3 Flash | ✅ 免费 | 1,500 次/天 | 15M tokens/天 |
| Gemini 2.5 Flash | ✅ 免费 | 1,500 次/天 | 15M tokens/天 |
| Gemini 2.5 Pro | ✅ 免费 | 50 次/天 | 1.5M tokens/天 |
| Gemini 2.0 Flash | ✅ 免费 | 1,500 次/天 | 15M tokens/天 |
| Gemma 3 系列 | ✅ 免费 | 14,400 次/天 | 200K tokens/天 |

⚠️ **重要说明：** 
- 免费层级的输入和输出都免费
- 每日配额在太平洋时间午夜重置
- 除每日限制外，还有每分钟速率限制
- 具体限制可在 [AI Studio 控制面板](https://aistudio.google.com/usage)查看
- 详细信息请查看 [API 服务文档](/services/api/google-ai-studio)
...
- 提供信息来源引用
- 确保答案的时效性和准确性
- ⚠️ **注意：** Grounding 功能可能会单独计费，请在使用前查看最新定价
...
### 数据隐私
- **免费层级：** 您的交互数据可能用于改进 Google 产品（可在设置中选择退出）
- **付费层级：** 启用计费后，Google 不会使用您的数据训练模型
- **建议：** 处理敏感数据时，建议使用付费层级或企业方案
...
|------|-----------------|------------|------|
| 每日请求数 | 50-1,500 | 50-1,000 | 14,400 |
| 每日 Tokens | 1.5M-15M | 不限 | 20K-1M |
| 上下文长度 | 1M-2M | 视模型而定 | 32K-128K |
| 多模态支持 | ✅ 强大 | 部分模型 | ❌ |
| 网络搜索 | ✅ | ❌ | ❌ |
| 需要信用卡 | ❌ | ❌ | ✅ (验证) |
| 中国大陆访问 | 🔧 需科学上网 | ✅ | 🔧 需科学上网 |
