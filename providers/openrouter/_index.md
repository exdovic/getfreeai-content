---
title: "OpenRouter - 25+ 免费 AI 模型聚合平台"
linkTitle: "OpenRouter"
description: "OpenRouter 聚合 25+ 免费 AI 模型！一个 API 访问 GPT-4、Claude、Gemini、Llama 等。每日 50-1000 次免费请求，统一接口，无需多个 API key，OpenAI 兼容格式。"
keywords:
  - OpenRouter
  - AI模型聚合
  - 25+免费模型
  ...
  - 免费AI路由
  - 模型切换
image: /images/providers/openrouter-og.png
type: docs
weight: 3
comments: true
prev: /providers/groq
...
**类型：** 免费增值（Freemium）- 提供 25+ 免费模型

---

## 📋 产品简介

OpenRouter 是一个 AI 模型聚合平台，通过统一的 API 接口提供来自多个提供者的 25+ 个免费模型，让开发者无需注册多个服务即可访问各种 AI 模型。

**核心特点：**
- 🎯 **模型聚合** - 一个 API 访问 25+ 免费模型
- 🔄 **OpenAI 兼容** - 完全兼容 OpenAI API 格式
- 🎁 **大量免费模型** - Llama 3.3 405B, DeepSeek, Qwen 等
- 🚀 **智能路由** - 自动选择最优提供者
- 💰 **灵活定价** - 免费层 + 按需付费
- 🔑 **BYOK 支持** - 可使用自己的 API 密钥（每月 100 万次免费）
...
1. 点击右上角的余额显示
2. 选择 **"Add Credits"**
3. 充值 $10（支持信用卡、加密货币等多种方式，具体以控制台为准）
...
- **模型：** 25+ 免费模型，包括 Llama, DeepSeek, Qwen 等
- **配额：** 基础 50 次/天，充值 $10 升级至 1000 次/天

### 3. BYOK (Bring Your Own Key)
- **类型：** 使用自己的提供商 API 密钥
- **特点：** 通过 OpenRouter 路由，计费在原提供商
- **免费配额：** 每月 100 万次 BYOK 请求免费
- **适用场景：** 已有 OpenAI/Anthropic 等账户的用户
...
**使用自己的密钥：**
- 支持使用您自己的 OpenAI、Anthropic、Google 等提供商密钥
- 享受 OpenRouter 的路由和故障转移功能
- 每月 100 万次 BYOK 请求免费

**适用场景：**
- 已有提供商账户和余额
- 需要更高的请求配额
- 想要利用 OpenRouter 的智能路由功能
...
- 免费模型性能已经很强大
- 根据任务选择合适的模型大小
- 💡 **提示：** 免费模型数量会动态变化，建议查看 [官方模型列表](https://openrouter.ai/models?free=true)
