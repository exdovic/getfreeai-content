...
|------------|----------|-------|
| Account Registration | ✅ Required | Supports email, Google, Discord |
...
| Top-up Suggestion | 💡 Optional | $10 upgrades to 1000 req/day |
...
6. ⚠️ **Important:** Immediately copy and save your API key
